...
entrepreneurs.forEach((entrepreneur) => {
  let agetoday = 2020 - entrepreneur.year
  console.log(`${entrepreneur.first} aurait ${agetoday}ans aujourd'hui`);
})

console.log("Les entrepreneurs par ordre alphabétique (nom de famille) : ");
